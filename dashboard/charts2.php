...
$month5 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth5' and YEAR(datesystem) = '$valyear5'");
$month5->execute();
$countmonth5 = $month5->rowCount();

$month4 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth4' and YEAR(datesystem) = '$valyear4'");
$month4->execute();
$countmonth4 = $month4->rowCount();

$month3 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth3' and YEAR(datesystem) = '$valyear3'");
$month3->execute();
$countmonth3 = $month3->rowCount();

$month2 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth2' and YEAR(datesystem) = '$valyear2'");
$month2->execute();
$countmonth2 = $month2->rowCount();

$month1 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth1' and YEAR(datesystem) = '$valyear1'");
$month1->execute();
$countmonth1 = $month1->rowCount();

$month0 = $db->prepare("SELECT * FROM transactions WHERE MONTH(datesystem) = '$valmonth0' and YEAR(datesystem) = '$valyear0'");
$month0->execute();
$countmonth0 = $month0->rowCount();

$maxvalue = max($countmonth5,$countmonth4,$countmonth3,$countmonth2,$countmonth1,$countmonth0);
$maxavecmarge = $maxvalue + 1;
