...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type,user_id,id){
        ...
        }else if(type == 'success-message3'){
            swal({
                title: "Nickel !",
                text: "Redémarrage effectué !",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-success",
                timer: 3000,
                type: "success"
            });
            }else if(type == 'success-message4'){
            swal({
                title: "Nickel !",
    	...
    	}else if(type == 'warning-message-and-cancelreboot'){
            swal({
                  ...
                  $.post("rebootseedbox.php", { identifiant: identifiant, ip:ip, port:port},
    function(data) {
     $('#results').html(data);
                  ...
                  if (dismiss === 'cancel') {
                    swal({
                      title: 'Annulé !',
                      text: 'Vos fichiers sont présents',
                      type: 'error',
                      confirmButtonClass: "btn btn-info",
                      buttonsStyling: false
                    })
            ...
            swal({
                  ...
                  swal({
                    title: 'Supprimée !',
                    text: "L'actualité est désormais supprimée !",
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    })
        ...
        function(data) {
         $('#results21').html(data);
            ...
            swal({
                  ...
                  swal({
                    title: 'Restaurer !',
                    text: 'Votre seedbox est réinitialiser!',
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    })

                  $.post("deleteparams.php", { identifiant: identifiant, ip:ip, port:22},
    function(data) {
     $('#results3').html(data);
                  ...
                  if (dismiss === 'cancel') {
                    swal({
                      title: 'Annulé !',
                      text: 'Votre seedbox est intacte',
                      type: 'error',
                      confirmButtonClass: "btn btn-info",
                      buttonsStyling: false
                    })
