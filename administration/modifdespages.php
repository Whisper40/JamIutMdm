        ...
        <div class="card">
            <div class="card-content">
                ...
                <form action="" method="post" id="myForm1" class="contact-form">
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Image du fond</label>
                      <div class="col-sm-10">
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Logo Central</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Titre Principal</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Bouton Gauche</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Lien bouton gauche</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Bouton Droite</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Lien bouton droite</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Titre Secondaire</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Description Secondaire</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
                  ...
                  <div class="row">
                      <label class="col-sm-2 label-on-left">Lien Facebook</label>
                      <div class="col-sm-10">
                          <div class="form-group label-floating is-empty">
                              <label class="control-label"></label>
