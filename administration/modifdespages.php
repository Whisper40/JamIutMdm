        ...
        <div class="card-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card-content">
                      <center>
                      <button onclick="myFunction();demo.showSwal('warningdeleteactu','<?php echo $user_id; ?>','jamesbond');" type="button" class="btn btn-primary btn-round btn-rose">Supprimer</button>
                      <button onclick="RetourIndex();" type="button" class="btn btn-primary btn-round btn-rose">Retour</button>
                      </center>
                     </div>
                  </div>
