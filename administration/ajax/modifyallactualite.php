...
require_once('../includes/connectBDD.php');
        ...
        if(!empty($id)&&!empty($user_id)&&!empty($title)&&!empty($description)&&!empty($formatimg)){
                ...
                $update = $db->prepare("UPDATE photopage SET title=:title, description=:description, title2=:title2, description2=:description2, title3=:title3, description3=:description3, formatimg=:formatimg WHERE id=:id");
