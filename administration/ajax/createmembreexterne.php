      ...
      if(!empty($user_id)&&!empty($nom)&&!empty($prenom)&&!empty($code)&&!empty($raison)&&!empty($email)){
                ...
                $insertlogs->execute(array(
                                 ...
                                 //owner = le mail de la personne
                                   ...
                                   <p style="line-height: 24px; text-align: justify; font-size: 12px; margin: 0;"><span style="font-size: 16px;">Etant non étudiant de l\'Université de Pau et des Pays de l\'Adour sur le site de Mont de Marsan mais désireux de faire partie de la Jeunesse Associative Montoise, vous trouverez ci-dessous le code UPPA nécessaire à votre inscription sur le site de l\'association.  </span></p>
                                   <p style="font-size: 12px; line-height: 18px; text-align: justify; margin: 0;"> </p>
                                   <p style="font-size: 12px; line-height: 24px; text-align: justify; margin: 0;"><span style="font-size: 16px;">Code UPPA : '.$code.'</span></p>
                                   <p style="font-size: 12px; line-height: 18px; text-align: justify; margin: 0;"> </p>
                                   <p style="font-size: 12px; line-height: 24px; text-align: justify; margin: 0;"><span style="font-size: 16px;">Vous n’avez pas demandé de code ? Alors</span><span style="font-size: 16px; line-height: 24px;">,</span><span style="font-size: 16px; line-height: 24px;"> <span style="color: #35bfb1; line-height: 24px; font-size: 16px;"><a href="https://jam-mdm.fr/contact.php" rel="noopener" style="text-decoration: underline; color: #35bfb1;" target="_blank">dites-le nous</a></span>.</span></p>
                                   </div>
                                   </div>
                                   <!--[if mso]></td></tr></table><![endif]-->
                                   <!--[if (!mso)&(!IE)]><!-->
