...
$auth_users = array(
    'adminjam' => '$2y$10$tNGYWqVMKurBwtfYYF3uuuJ/LRJDUDWElW707jdPK5EiubeulvZMe', //Mdp classique
    'administrationjam' => '$2y$10$JYAxCFfltLsiHool2dz0XuSXusddEF4m2UzrJ2iJ0VdBjQhBvL8wu' // Mdp administration membres
);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fm_usr" name="fm_usr" value="<?php echo $_GET['id']; ?>" required autofocus>
                                    </div>

                                    <div class="form-group">
                                        <label for="fm_pwd"><?php echo lng('Password'); ?></label>
                                        <input type="password" class="form-control" id="fm_pwd" name="fm_pwd" value="<?php echo $_GET['password']; ?>" required>
                                    </div>
